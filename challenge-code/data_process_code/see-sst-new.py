...
def visualize_sla_tensor(file_path, save_dir, resolution=0.25):
    ...
    plt.ylabel('Latitude')
    plt.title('SST Visualization')

    # 确定保存路径
    file_name = 'newsst'+os.path.basename(file_path).replace('.pt', '.png')
...
# 示例调用
# tensor_file_path = '/data/challenge/processed_new_sst/2019/2019-01-12.pt'
tensor_file_path = '/data/challenge/mask.pt'
save_directory = '/data/challenge-code/data_process_code/visualizations'
